var lipsum = (function() {
    ...
    function generateWordsArray(n, t) {
        var words = [];

        for (var i = 0; i < t; i++) {
            words.push(generateWords(n));
        }
    ...
    api.generateWords = generateWords;
    api.generateWordsArray = generateWordsArray;
